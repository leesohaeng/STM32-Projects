...
void ssd1306_TestBorder() {
    ...
    do {
        ...
        if((y == 0) && (x < 129))
            x++;
        else if((x == 129) && (y < (SSD1306_HEIGHT-1)))
            y++;
        else if((y == (SSD1306_HEIGHT-1)) && (x > 2))
            x--;
        else
            y--;
...
void ssd1306_TestLine() {
  ...
  ssd1306_Line(2,1,SSD1306_WIDTH - 1,SSD1306_HEIGHT - 1,White);
...
void ssd1306_TestRectangle() {
  ...
  for(delta = 0; delta < 5; delta ++) {
    ssd1306_DrawRectangle(2 + (5*delta),1 + (5*delta) ,SSD1306_WIDTH-1 - (5*delta),SSD1306_HEIGHT-1 - (5*delta),White);
  }
  ssd1306_UpdateScreen();
  return;
}
